    ...
    while True:
        ...
        while True:
            ...
            if inCode == "next":
                ...
                codes_to_remove = input(
                    " Enter card code to remove (to enter multiple codes seperate them by ' '):  "
                )
                ...
                for code in target_codes:
                    try:
                        ...
                        print(str(code), "was not in your current hand")
                ...
                try:
                    ...
                    order_list = input(
                        f" Enter index order you want your hand (seperate card index by ' ')?  "
                    )
                    ...
                    print(current_hand_codes)
                    decryptor(
                        base_deck, card_offset, inverse, current_hand_codes, card_color
                    )
                ...
                for code in new_codes:
                    if validate(code) == False:
                        ...
                        print(str(code), "was an invalid card code")
